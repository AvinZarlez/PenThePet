...
const LANGUAGES = {
    en: {
        ...
        editor_btn_copy_url: 'Copy URL',
        editor_btn_play_map: 'Play Map',
        ...
        tile_bee_description: 'Removes 5 from your score when penned.',
        tile_bee_aria: 'Bee tile at row {row}, column {col}. Costs 5 points. Cannot place a wall here.',
    ...
    es: {
        ...
        editor_btn_copy_url: 'Copiar URL',
        editor_btn_play_map: 'Jugar mapa',
        ...
        tile_bee_description: 'Resta 5 de tu puntuación cuando está cercada.',
        tile_bee_aria: 'Casilla de abeja en fila {row}, columna {col}. Cuesta 5 puntos. No se puede colocar un muro aquí.',
