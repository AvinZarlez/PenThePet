...
const LANGUAGES = {
    en: {
        ...
        editor_status_copied_url: 'Copied URL to clipboard.',
        editor_status_copy_failed: 'Unable to copy URL. Copy it manually from the field below.',
    ...
    es: {
        ...
        editor_status_copied_url: 'URL copiada al portapapeles.',
        editor_status_copy_failed: 'No se pudo copiar la URL. Cópiala manualmente desde el campo.',
