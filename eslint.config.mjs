    ...
    js.configs.recommended,
    {
        languageOptions: {
            ...
            globals: {
                ...
                isBlockingNumericId: 'readonly',
                isFillableTile: 'readonly',
                isFillableNumericId: 'readonly',
                isWallState: 'readonly',
                getWallTransform: 'readonly',
